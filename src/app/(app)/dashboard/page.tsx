...
export default function DashboardPage() {
  ...
  const renderDashboard = () => {
    switch (user.role) {
      ...
      case 'Super Admin':
        return <SuperAdminDashboard user={user} recentSessions={MOCK_SESSIONS.sort((a,b) => new Date(b.dateOfSession).getTime() - new Date(a.dateOfSession).getTime())} clients={MOCK_CLIENTS} team={MOCK_TEAM} />;
      default:
