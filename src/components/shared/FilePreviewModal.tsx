      ...
      case 'presentation':
        ...
        return (
           <div className="p-4 text-center bg-muted rounded-md">
             ...
             <iframe 
                src={attachment.url.startsWith('https://picsum.photos') ? `https://docs.google.com/gview?url=${encodeURIComponent('https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf')}&embedded=true` : attachment.url } // Fallback to a dummy PDF view if picsum
